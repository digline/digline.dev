...
.PHONY: docs preview serve css claims actions source home opening agents operator indexes posts feed card glyphs assets bar translate i18n translations translation-checks agent build check clean
