...
description: 'Otto capitoli sulla valutazione delle applicazioni LLM nella pratica: casi, ground truth, check, il giudice, la baseline, manutenzione. Parlano del problema, non dello strumento.'
search:
  exclude: true
...
- **[1. Che cosa stai rilasciando davvero](../../handbook/01-what-you-are-shipping.md)** —
...
- **[3. Ground truth: quando nessuno te la fornisce](../../handbook/03-ground-truth.md)** — da
...
- **[8. Per i team che costruiscono per altri](../../handbook/08-for-teams-building-for-others.md)**
